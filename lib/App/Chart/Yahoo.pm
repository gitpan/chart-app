...
#
use constant EXCHANGES_URL => 'http://finance.yahoo.com/exchanges';
#
...
# latest
#
# Eg. http://download.finance.yahoo.com/d/quotes.csv?f=snc4b3b2d1t1oml1c1vqdx&e=.csv&s=GM
#
...
sub latest_parse {
  ...
  foreach my $line (App::Chart::Download::split_lines ($content)) {
    ...
    if (DEBUG) { require Data::Dumper;
                 ...
                 my @x = $csv->fields();
                 print Data::Dumper->Dump([\@x],['csv_fields']); }
...
# $time is h:mp like 10:05am, in $server_timezone
#
...
#
#     http://ichart.finance.yahoo.com/table.csv?s=AMP.AX&d=10&e=26&f=2007&g=d&a=0&b=4&c=2000&ignore=.csv
#
